<div>
    ...
    <a class="px-4 py-1 pt-2 text-white bg-gray-900 rounded" href="{{route("admin.transaction.show",["id"=>$form['item_id']])}}">Back to items <i class="fas fa-arrow-left"></i></a>
    @if(session()->has("new")) <p class="p-2 mt-4 text-center text-white bg-green-600 rounded-lg">data updated</p>  @endif
