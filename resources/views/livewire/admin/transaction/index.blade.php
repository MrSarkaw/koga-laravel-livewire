<div>
    <a class="px-4 py-1 pt-2 text-white bg-gray-900 rounded" href="{{route("admin.transaction.add")}}">Add New <i class="fas fa-plus"></i></a>
            ...
            <tbody class="px-2 py-2">
                ...
                <tr>
                  ...
                  <td class="p-2 border border-gray-900 ">
                    <a class="px-3 py-1 " href="{{ route("admin.transaction.show",["id"=>$row->item_id]) }}">
