<div>
    <a class="px-4 py-1 pt-2 text-white bg-gray-900 rounded" href="{{route("admin.transaction")}}">Back to items <i class="fas fa-arrow-left"></i></a>
             ...
             <tbody class="px-2 py-2">
                ...
                <tr>
                  ...
                  <td class="flex justify-between p-2 border border-gray-900 ">
                    <a href="{{ route("admin.transaction.update",["id"=>$row->id]) }}">
                      <i class="fas fa-cog"></i>
                    </a>  
                    @livewire("admin.user.deleteuser",["id"=>$row->id,"model"=>"transactions"],key($row->id))
                  </td>
                </tr>
                @endforeach
