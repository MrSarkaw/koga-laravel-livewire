<div>
    <a class="px-4 py-1 pt-2 text-white bg-gray-900 rounded" href="{{route("admin.unit.add")}}">Add New <i class="fas fa-plus"></i></a>
            ...
            <tbody class="px-2 py-2">
                ...
                <tr>
                  ...
                  <td class="flex justify-between p-2 border border-gray-900">
                      <a href="{{route("admin.unit.update",[$row->id])}}"><i class="fas fa-edit"></i></a>
                      @livewire("admin.user.deleteuser",["id"=>$row->id,"model"=>"unit"],key($row->id))
                  </td>
                </tr> 
                 @endforeach
